...
function getRenderDefault(){
  ...
  const sideBarCompletedIcon = document.createElement("span");
  sideBarCompletedIcon.classList.add("material-symbols-outlined");
  sideBarCompletedIcon.textContent = "task";
  const sideBarCompletedStatus = document.createElement("span");
  sideBarCompletedStatus.textContent = "0";
  sideBarCompletedStatus.classList.add("sidebar-complete-status");
  ...
  sideBarFields.appendChild(sideBarCompleted);
  sideBarCompleted.appendChild(sideBarCompletedIcon);
  sideBarCompleted.appendChild(sideBarCompletedTitle);
  sideBarCompleted.appendChild(sideBarCompletedStatus);
